...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      return this.split_results_separator = this.options.split_results_separator || false;
    };
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      var classes, option_el, result, separatedText, value, _i, _len;
      ...
      if (this.split_results_separator) {
        separatedText = option.search_text.split(this.split_results_separator);
        result = '';
        for (_i = 0, _len = separatedText.length; _i < _len; _i++) {
          value = separatedText[_i];
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.split_results_separator) {
        this.search_results.addClassName('chosen-results-split');
      }
      this.search_field_scale();
    ...
    Chosen.prototype.wrap_text_in_span = function(text) {
